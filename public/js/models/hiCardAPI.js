...
export class Client {
    ...
    medicalnetworkusers2(body) {
        ...
        return this.http.fetch(url_, options_).then((_response) => {
            return this.processMedicalnetworkusers2(_response);
        });
    }
    processMedicalnetworkusers2(response) {
        const status = response.status;
        let _headers = {};
        if (response.headers && response.headers.forEach) {
            response.headers.forEach((v, k) => _headers[k] = v);
     ...
     * @return Success
     */
    medicalnetworkusers3(id) {
        let url_ = this.baseUrl + "/api/medicalnetworkusers/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response) => {
            return this.processMedicalnetworkusers3(_response);
        });
    }
    processMedicalnetworkusers3(response) {
        const status = response.status;
        let _headers = {};
        if (response.headers && response.headers.forEach) {
            response.headers.forEach((v, k) => _headers[k] = v);
        ...
        if (status === 200) {
            return response.text().then((_responseText) => {
                let result200 = null;
                let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
                result200 = ApiMedicalNetworkUserModelControllerActionResult.fromJS(resultData200);
                return resultData200;
            });
        }
        else if (status !== 200 && status !== 204) {
     ...
     */
    activate(id) {
        let url_ = this.baseUrl + "/api/medicalnetworkusers/{id}/activate";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
     ...
     */
    deactivate(id) {
        let url_ = this.baseUrl + "/api/medicalnetworkusers/{id}/deactivate";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
    ...
    /**
     * Get user infor by security module identifier
     * @return Success
     */
    details(securityModuleId) {
        let url_ = this.baseUrl + "/api/medicalnetworkusers/{securityModuleId}/details";
        if (securityModuleId === undefined || securityModuleId === null)
            throw new Error("The parameter 'securityModuleId' must be defined.");
        url_ = url_.replace("{securityModuleId}", encodeURIComponent("" + securityModuleId));
        url_ = url_.replace(/[?&]$/, "");
        let options_ = {
            method: "GET",
            headers: {
    ...
    /**
     * Gets the cards cee xml
     * @return Success
     */
    token(id, accessToken) {
        let url_ = this.baseUrl + "/api/membercards/{id}/ceeXml/token/{accessToken}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
    ...
    /**
     * Gets the card's pdf letter invitation
     * @return Success
     */
    token2(id, accessToken) {
        let url_ = this.baseUrl + "/api/membercards/{id}/pdfLetter/token/{accessToken}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        if (accessToken === undefined || accessToken === null)
        ...
        return this.http.fetch(url_, options_).then((_response) => {
            return this.processToken2(_response);
        });
    }
    processToken2(response) {
        const status = response.status;
        let _headers = {};
        if (response.headers && response.headers.forEach) {
            response.headers.forEach((v, k) => _headers[k] = v);
    ...
    /**
     * Gets base 64 encoded PDF representation of the card
     * @return Success
     */
    pdf(id) {
        let url_ = this.baseUrl + "/api/membercards/{id}/pdf";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
    ...
    details3(id, claimNumber) {
        ...
        return this.http.fetch(url_, options_).then((_response) => {
            return this.processDetails3(_response);
        });
    }
    processDetails3(response) {
        const status = response.status;
        let _headers = {};
        if (response.headers && response.headers.forEach) {
            response.headers.forEach((v, k) => _headers[k] = v);
...
export class ApiMedicalFacilityModel {
    ...
    init(_data) {
        if (_data) {
            ...
            this.medicalNetworkID = _data["medicalNetworkID"];
        }
    }
    static fromJS(data) {
        data = typeof data === 'object' ? data : {};
    ...
    toJSON(data) {
        ...
        data["medicalNetworkID"] = this.medicalNetworkID;
        return data;
    }
}
...
export class ApiMedicalNetworkUserModelControllerActionResult {
    constructor(data) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
    ...
    init(_data) {
        if (_data) {
            ...
            this.payload = _data["payload"] ? ApiMedicalNetworkUserModel.fromJS(_data["payload"]) : undefined;
        }
    }
    static fromJS(data) {
        data = typeof data === 'object' ? data : {};
        let result = new ApiMedicalNetworkUserModelControllerActionResult();
        result.init(data);
        return result;
    }
    toJSON(data) {
